...
<html xmlns="http://www.w3.org/1999/xhtml"> 
  ...
  <body> 
	Input : <input size = "200" type="text" id='input' value = 'Sukhumwit 21, Ari 21, Siam, siam paragon, Victory Monument'/> <img src='http://together.in.th/ajax/loading.gif' id='loading' /> <br \>
	<br \>	
